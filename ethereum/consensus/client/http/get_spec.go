...
type spec struct {
	...
	MAX_BLS_TO_EXECUTION_CHANGES               view.Uint64View `json:"MAX_BLS_TO_EXECUTION_CHANGES,string"`
	MAX_WITHDRAWALS_PER_PAYLOAD                view.Uint64View `json:"MAX_WITHDRAWALS_PER_PAYLOAD,string"`
	MAX_VALIDATORS_PER_WITHDRAWALS_SWEEP       view.Uint64View `json:"MAX_VALIDATORS_PER_WITHDRAWALS_SWEEP,string"`
}
...
func (s *spec) toSpec() *beaconcommon.Spec {
	...
	rvs.BELLATRIX_FORK_EPOCH = s.BELLATRIX_FORK_EPOCH
	rvs.BELLATRIX_FORK_VERSION = s.BELLATRIX_FORK_VERSION
	rvs.CAPELLA_FORK_EPOCH = s.CAPELLA_FORK_EPOCH
	rvs.CAPELLA_FORK_VERSION = s.CAPELLA_FORK_VERSION
	rvs.MAX_BLS_TO_EXECUTION_CHANGES = s.MAX_BLS_TO_EXECUTION_CHANGES
	rvs.MAX_WITHDRAWALS_PER_PAYLOAD = s.MAX_WITHDRAWALS_PER_PAYLOAD
	rvs.MAX_VALIDATORS_PER_WITHDRAWALS_SWEEP = s.MAX_VALIDATORS_PER_WITHDRAWALS_SWEEP
